        ...
        <>
            ...
            <main className="page">
                <div className="container">
                    <ContentNavigator page="privacy" lang={i18n.language}/>
                    <div className="page-wrapper">
                        <div className="row">
                            <div className="col-12">
                                <div className="page-headline">Preamble</div>
                            </div>
                            <div className="col-12 page-body">
                                <p>
                                    Winfinity N.V. (hereinafter – Organization) represents the organizer of gambling business and owner of gambling business license, having been operating since 2021 and provides service on the online gaming
                                </p>

                                <p>
                                    website https://planetaxbet.com/ (hereinafter “Product”) organized within the frames of the gaming license.
                                </p>

                                <p>
                                    With the purpose of ensuring the highest standards of the offered service and complete fulfillment of requirements of Law of Client’s Country, the Organization has elaborated the given policy “On Anti-Money-Laundering Control” (hereinafter “Policy”), based on: the international Law of “On Facilitating the Prevention of Illicit Income Legalization”, provision of Financial Monitoring Service “On receiving, systematization, processing information by Tax Service Provider and the rule of submitting such information to FMS” and recommendations of Financial Action Task Force (FATF). The goal of the Policy is to elaborate identification of risks, analyses, conduct, reduce and control system for the Organization against money laundering and terrorism financing.
                                </p>

                                <p>
                                    The Policy is confirmed by head of Organization and is subject to annual renovation.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="page-headline">Definition of Terms</div>
                            </div>
                            <div className="col-12 page-body">
                                <p>
                                ...
                                <p>the total amount of which exceeds 30 000 GEL or its equivalent in different rate and with regard to which there is reasonable ground for suspecting that they were divided deliberately with the aim to prevent sending report on transaction. The analysis conducted by monitoring staff member, represents the ground for substantiating the doubt.
                                </p>
                                <p>Monitoring Staff Member – The employee designated on the ground of the Resolution, properly drafted by the Organization, who is liable for anti-money laundering coordination within the Organization
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="page-headline">Inner Control System</div>
                            </div>
                            <div className="col-12 page-body">
                                <p>
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="page-headline">Internal Policies and Procedures</div>
                            </div>
                            <div className="col-12 page-body">
                                <p>The given policy is the basis for the internal control of the Organization, which determines the main control mechanisms, responsibilities and principles for money laundering and terrorist financing prevention.
                                </p>
                                <p>The procedure “Know Your Client” represents an integral part of the Policy, where the description of monitoring processes of the Client identification, verification and business relationship is provided.
                                </p>
                                <p>The given Policy determines the criteria of granting risks to the Organization products and the Clients, and corresponding risk measures for the clients’ identification and verification. The given policy is available for all employees of the Organization.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-12 page-body">
                                ...
                                <p>Specification of proper control mechanisms for medium and high risk category products represents the goal for identification and assessment of risk-factors, on the grounds of which it will be possible to reduce and manage the current risks, threating the Organization, of Money Laundering and Terrorism.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-12 page-body">
                                <p>Identification of the Clients
                                </p>
                                <p>Identification and verification of the clients represents one of the most significant control mechanisms for reduction of risks of financing Money Laundering and Terrorism. Taking into account the approach based on the risk, the intensity of verification measures depend on the specific risk category, which the client belongs to.
                                </p>
                                <p>The Organization identifies the Client and takes reasonable measures for verification prior to making the deal or within the process of building business relationship.
                                </p>
                                <p>Standard Measures of Identification
                                </p>
                                <p>Standard measures of identification are used for low and medium-risk clients. According to the given procedure, the Client has to provide the following necessary documentation at the moment of making a deal or building business relations:
                                </p>
                                <p>ID card of a foreign country’s citizen;
                                </p>
                                <p>Passport of a foreign country’s citizen;
                                </p>
                                <p>The document confirming the entity’s identity must meet the following requirements:
                                </p>
                                <p>Must include requisites specific to such type of document (number, date of issue and validity, protective attributes etc.);
                                </p>
                                <p>Must include passport holder’s photo;
                                </p>
                                <p>Photo must enable affirmation of the authentication with the document holder; Must be valid
                                    Must not be substantially damaged.
                                </p>
                                ...
                                <p>monitoring, requires documents and/or any other information on transaction (operation) and its participants.
                                </p>
                                <p>As a result of identification procedure of the Client, the following data should be indicated:
                                </p>
                                <p>Full name; Nationality;
                                </p>
                                <p>Date and place of birth; Place of residence;
                                </p>
                                <p>ID (passport) number and personal number of the citizen according to the ID card (Passport);
                                </p>
                            </div>
                        </div>
