                        ...
                        <div className="container">
                            <ul className="navbar-nav">
                                <li className="nav-item d-none d-md-flex">
                                    <a className="nav-link active home" href="./index.html">
                                        <svg
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" href="./casino.html">Casino</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href="./slots.html">Slot</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href="./promo.html">Promo</a>
                                </li>
                            </ul>
                        </div>
                    </div>
